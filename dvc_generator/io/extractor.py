"""
Volume extraction from large volumetric images.
"""
...
class VolumeExtractor:
    """Extract fixed-size volumes from large volumetric images."""
    ...
    def extract_volumes(
        ...
        """
        Extract multiple volumes from source images.

        Args:
            tif_volumes: List of loaded source volumes
    ...
    def _extract_random(
        ...
        """
        Randomly extract volumes from source images.
    ...
    def _count_valid_positions(self, file_shape: Tuple[int, int, int]) -> int:
        ...
        Args:
            file_shape: Shape of the source volume (D, H, W)
